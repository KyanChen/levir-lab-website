Required fields:
必须的字段：
Name, start date, image, position, email, description
Optional fields:
其他非必须的字段：
---
# REQUIRED
name: Keyan Chen # 可以加上后缀，也可不加比如 Keyan Chen, Ph.D.
timeline_name: 非必需 # If you would like your name to appear differently on the Lab timeline, fill out this line.
